...
| Sentence diagram | Signed-in Diagram control on biblical lines. Macula Hebrew via Bibla Lingua. | MT/WLC syntax, not the Qumran line. Greek NT trees were not ingested with parent_id. Some latter prophets fall back to role clusters. |
